...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/cpu_simulation/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/cpu_simulation/archive/master.zip", tmp)
    file += "master"
